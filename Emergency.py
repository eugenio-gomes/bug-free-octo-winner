class FireEmergency:
def
__init__ (self, location, severity, status):
...
def __str__ (self):
return f
  "FireEmergency(location={self.location}, severity={self.severity}, status={self.status})"
...
super ().__init__ (location, "high",
					  status)
#Setting severity to 'high' for explosions
...
def __str__ (self):
return f
  "Explosion(location={self.location}, intensity={self.intensity}, status={self.status})"
...
def __str__ (self):
return (f
		   "Storm(location={self.location}, magnitude={self.magnitude}, affected_area={self.affected_area}, status={self.status}, "
		   
 f
		   "category={self.category}, casualties={self.casualties}, infrastructure_damage={self.infrastructure_damage})")
	
 
 
#Function to create a Storm object with user input
